...
const Strategy = () => {
  return (
    <div>
      {/* business goal area */}
      <div className="rts-business-goal rts-business-goal5 mt--0 rts-section-gapBottom">
          ...
          <div className="row justify-content-center align-items-center">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 first-child">
              <ul className="content-box first">
                <li className="content left">
                  ...
                  <p className="desc">Purus dui eget sollicitudin curae leo proin platea cras, morbi torquent massa</p>
                </li>
            ...
            <div className="col-xl-4 col-lg-12 col-md-12 col-sm-12 text-center">
              <div className="business-goal-one">
                ...
                <div className="shape"><img src="assets/images/business-goal/icon/line.png" alt="" /></div>
              </div>
            </div>
            {/* business goal right */}
