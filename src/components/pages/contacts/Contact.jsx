        ...
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
              <div className="single-contact-one-inner">
                <div className="thumbnail">
                  <img src="/assets/images/contact/01.png" alt="Phone icon" />
                </div>
                <div className="content">
                  <div className="icone">
                    <img src="/assets/images/contact/shape/01.svg" alt="Call icon" />
                  </div>
                  <div className="info">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
              <div className="single-contact-one-inner">
                <div className="thumbnail">
                  <img src="/assets/images/contact/02.png" alt="Email icon" />
                </div>
                <div className="content">
                  <div className="icone">
                    <img src="/assets/images/contact/shape/02.svg" alt="Email shape" />
                  </div>
                  <div className="info">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
              <div className="single-contact-one-inner">
                <div className="thumbnail">
                  <img src="/assets/images/contact/03.png" alt="Location icon" />
                </div>
                <div className="content">
                  <div className="icone">
                    <img src="/assets/images/contact/shape/03.svg" alt="Location shape" />
                  </div>
                  <div className="info">
          ...
          <div className="row">
            <div className="col-12">
              <div className="contact-map-area-fluid">
                ...
                ></iframe>
                <img className="location" src="/assets/images/contact/shape/location.svg" alt="Business location marker" />
              </div>
            </div>
          </div>
        </div>
